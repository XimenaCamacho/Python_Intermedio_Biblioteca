...
class Ventana_principal:
    def __init__(self, ventana):
        self.root = ventana
        # Posicionamiento y tamano de ventana
        ancho_ventana = 1160
        alto_ventana = 500
        ...
        self.edicion = Label(self.root, text="Edición", font="bold")
        ...
        # Definicion de boton de muestra la imagen de producto
        boton_tapa = Button(
            self.root,
            text="Ver Tapa",
        ...
        self.tree.heading("col4", text="Edición")
        ...
        # Barra de scroll horizontal por si se llega a necesitar
        """
